...
export const metadata: Metadata = {
  ...
  description:
    'Building intelligent software with data, AI, and open source. BS in Data Science @ IIT Madras | Summer Intern @ IIT Ropar (VLED Lab) | OSCI 2026 Contributor | Founder @ Technical Innovations Forum.',
  keywords: [
    'Ansh Varshney',
    'anshvarshney1502',
    'Ansh',
